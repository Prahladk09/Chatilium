...
const ChatContainer = () => {
  const {messages, getMessage, isMessageLoading, selectedUser, subscribeToNewMessage, unsubscribeToNewMessage} = useChatStore();
  ...
  },[selectedUser._id, getMessage, subscribeToNewMessage, unsubscribeToNewMessage]);
